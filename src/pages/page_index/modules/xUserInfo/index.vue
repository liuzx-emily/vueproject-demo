<template>
    <section v-loading.fullscreen.lock="loading" element-loading-background="rgba(0,0,0,0.05)">
        ...
        <el-dialog title="修改个人信息" :visible.sync="dialogVisible" width="500px" :modal-append-to-body='false' :close-on-click-modal="false" :close-on-press-escape="false">
            <el-form ref="dialogForm1" label-width="75px" style="width:450px;" size="medium" :model="dialogData" :rules="dialogRule1" status-icon>
        ...
        <el-dialog title="修改密码" :visible.sync="changePW_dialogVisible" width="500px" :modal-append-to-body='false' :close-on-click-modal="false" :close-on-press-escape="false">
            <el-form ref="changePW_dialogForm" label-width="85px" style="width:450px;" size="medium" :model="changePW_dialogData" :rules="changePW_dialogRule" status-icon>
    ...
    data: function() {
        ...
        return {
            ...
            dialogRule1: {
                ...
                // 手机
                phone: [
                    { validator: phoneValidation, trigger: ['blur', 'change'] }
                ],
                // 邮箱
                email: [

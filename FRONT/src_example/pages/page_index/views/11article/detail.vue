...
<template>
    <section v-loading.fullscreen.lock="loading" element-loading-background="rgba(0,0,0,0.05)">
        ...
        <section class="box-with-shadow">
            <div class="auditfail-reason-box" v-if="this.dialogData.audit==2">审核未通过，原因：{{dialogData.reason}}</div>
            <el-form ref="dialogForm1" label-width="100px" :model="dialogData" :rules="dialogRule1" style="width:95%" @submit.native.prevent :disabled="readOnly">
                ...
                <el-form-item label="发布时间" prop="time" style="display:inline-block;width:50%;">
                    <el-date-picker v-model="dialogData.time" type="date" value-format="timestamp" style="width:140px;"></el-date-picker>
                </el-form-item>
            </el-form>

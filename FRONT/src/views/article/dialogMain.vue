...
<template>
	<section v-loading.fullscreen.lock="loading">
		<el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="1000px" top="5vh" :modal-append-to-body='true' :close-on-click-modal="false">
			...
			<el-form ref="form" label-width="100px" :model="dialogData" :rules="rules" @submit.native.prevent :disabled="readonly" style="margin-top:10px">
...
<script>
	...
	export default {
		props: {
			refreshFunc: { type: Function, default: () => {}, },
		},
		data() {
			return {
				loading: false,

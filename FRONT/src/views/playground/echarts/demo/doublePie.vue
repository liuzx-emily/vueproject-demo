		...
		methods: {
			...
			drawChart() {
				...
				option.series = [{
						...
						data: [
							{ value: 320, name: '动物', itemStyle: { color: "#75bbff" } },
							{ value: 100, name: '植物', itemStyle: { color: "#ffba75" } },
						]
					},
					{
						name: '',
						...
						radius: ['50%', '65%'],
						data: [
							{ value: 150, name: '狗', itemStyle: { color: "#aaddff" } },
							{ value: 170, name: '猫', itemStyle: { color: "#3388ff" } },
							{ value: 100, name: '植物', itemStyle: { color: "#ffba75" } },
						]
					}
				];

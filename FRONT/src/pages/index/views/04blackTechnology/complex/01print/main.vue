...
<script>
import view1 from '~/pages/index/views/02componentInstructions/01table/table-usage.vue'
import view2 from '~/pages/index/views/03pluginDemo/01echarts/main.vue'
export default {

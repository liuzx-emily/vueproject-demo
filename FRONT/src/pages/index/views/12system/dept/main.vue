    ...
    <section v-loading.fullscreen.lock="loading" element-loading-background="rgba(0,0,0,0.1)">
        <section class="search-condition">
            <section class="search-btn-box">
                <el-button v-permission:dept="1" type="primary" @click="openDial_main(1)">新增</el-button>
            </section>
        </section>
        <treeTable :data="treeTableData" :controlColumn="treeTableProps.controlColumn" :expandAll="treeTableProps.expandAll">
            ...
            <el-table-column label="操作" width="250px">
                <template slot-scope="scope">
                    <el-button class="size-small" type="warning" v-permission:dept="2" @click="openDial_main(2,scope.row)">编辑</el-button>
                    <el-button class="size-small" type="success" v-permission:dept="3" @click="openDial_main(3,scope.row)">查看</el-button>
                    <el-button class="size-small" type="danger" v-permission:dept="4" @click="openConfirm_delete(1,scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </treeTable>
        <!-- 弹窗：主 -->
